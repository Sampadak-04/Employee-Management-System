...
<body>
 <%@ include file="HomeNav.jsp" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="header-content text-center">
                            ...
                            <p class="text">Modified way to manage and access the employee details</p>
                            <ul class="header-btn">
    ...
    <section id="team" class="pricing-area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-10">
                        <h4 class="title">Developer team</h4>
                        <p class="text">Here is the developer team of this system who have contributed<br>for making an innovative website.</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing mt-40">
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">Sampada Kothari</h5><br>
                            <span class="name">Java Full stack Developer</span>
                        </div>
                       <div>
                        	<img src="images/samweb.jpeg">
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing mt-40">
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">Mansi Kaleshwarkar</h5><br>
                            <span class="name">Java Full stack developer</span>
                        </div>
                        <div>
                        	<img src="images/mansi.jpg">
                        </div>
                        <div class="pricing-btn text-center">
                            <a class="main-btn" href="#">CONTACT</a>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing mt-40">
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">Shravani Kaleshwarkar</h5><br>
