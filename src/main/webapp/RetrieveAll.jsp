...
<body>
	...
	<table id="table1" class="table">
		<legend style="color: blue; font-size: 30px;">
			<b><center>All Employees details</center></b>
		</legend>
		<thead>
			<tr>
   ...
   %>
		<tbody>
			<tr class="active">
				...
				<td><%=emp.getEmail() %></td>
				<td><%=emp.getSalary() %></td>
				<td><a href="Update.jsp?id=<%=emp.getEmpId()%>"><button
							class="btn btn-primary" style="font-size: 15px">
							<span class="glyphicon glyphicon-pencil"></span>&nbspUpdate
						</button></a></td>
				<td><a href="DeleteServlet?id=<%=emp.getEmpId()%>"><button
